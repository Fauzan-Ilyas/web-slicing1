...
import Rent1 from "../../public/assets/images/rent1.jpg";
import Rent2 from "../../public/assets/images/rent2.jpg";
import Rent3 from "../../public/assets/images/rent3.jpg";
import Rent4 from "../../public/assets/images/rent4.jpg";
      ...
      <div className="card flex items-center justify-center m-5 mx-20">
        ...
        >
          ...
          <div className="box m-5 w-60 relative">
            ...
            <img src={Rent1} alt="" className="rounded-xl h-[200px]" />
          ...
          <div className="box m-5 w-60 relative">
            ...
            <img src={Rent2} alt="" className="rounded-xl h-[200px]" />
          ...
          <div className="box m-5 w-60 relative">
            ...
            <img src={Rent3} alt="" className="rounded-xl h-[200px]" />
          ...
          <div className="box m-5 w-60 relative">
            ...
            <img src={Rent4} alt="" className="rounded-xl h-[200px]" />
